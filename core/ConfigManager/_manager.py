...
class ConfigManager:
    ...
    def __init__(self, cache: bool = True, use_global_cache: bool = False):
    ...
    async def get_default_item(self, user_id: str) -> str:
        ...
        :return: 配置项
        """
        return await self._user_config_manager.get_default_item(user_id)
    ...
    async def set_default_item(self, user_id: str, item: str) -> None:
        ...
        :return: None
        """
        await self._user_config_manager.set_default_item(user_id, item)
